---
sidebar_position: 2
title: Exploring transmission and deep narrative patterns
description: The site’s positive program—testing how messianic and mediator stories may connect across Eurasia, with mechanisms, evidence types, and falsifiers.
---
...
```mermaid
flowchart LR
  structural[Structural_recurrence]
  areal[Areal_diffusion]
  contact[Attested_contact]
  deep[Deep_inheritance_hypothesis]

  structural --> compare[Compare_and_test]
  areal --> compare
  contact --> compare
  deep --> compare
  compare --> tiers[Method_tiers_and_mechanisms]
```
