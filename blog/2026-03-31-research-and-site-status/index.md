---
slug: research-and-site-status
title: 'Research focus and where the site stands (March 2026)'
date: 2026-03-31
authors: [messiahcomplex]
tags: [site-status, research]
---

Messiah Complex is a **Docusaurus** site for comparative work on **messiah figures**, **mediator saviors**, and **transmission** across West, Central, and South Asia and the Mediterranean. This post replaces the stock blog scaffold and summarizes how we organize evidence—and what is queued next.
...
## Recently settled or strengthened areas

Recent passes have **filled in Sources & dating** on several flagship figure pages (including early Christian parousia expectation, Zoroastrian Saoshyant, and Roman Mithraism), added **site-wide guidance** for citations and curated templates, and expanded the **figure catalog** (for example Heracles, Gilgamesh, Dumuzi/Tammuz, Orpheus, Elijah and Enoch—while entries such as Prometheus or Quetzalcoatl remain gaps noted on the [research backlog](/docs/overview/research-backlog)).

The [Mithra cluster hub](/docs/mithras) remains the central entry for Iranian *Miθra*, Roman mysteries, onomastics, and related Pure Land / Silk Road side threads.

## What is in flight

Work is tracked explicitly on the [research backlog](/docs/overview/research-backlog) (task IDs and checklists—not promises). High-leverage open rows include:
...
Expect **infrequent, editorial** posts: milestone summaries, methodological reminders, or backlog snapshots—not a serial argument. For substantive claims, prefer the versioned documentation tree so evidence and dating stay co-located with the assertions.
